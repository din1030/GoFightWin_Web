        ...
        <div role="tabpanel" class="tab-pane" id="basicdata">
            ...
            <form id="weight_form" class="form-horizontal" action="/GoFightWin/BasicData/add_weight_action" method="post">
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="weight">體重</label>  
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="weight_date">測量日期</label>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="weight_time">測量時間</label>
                    <div class="col-sm-4 col-md-4">
            ...
            <form class="form-horizontal" action="/GoFightWin/BasicData/add_temp_action" method="post">
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="temperature">體溫</label>  
                    <div class="col-sm-4 col-md-4 input-group">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="temp_date">測量日期</label> 
                    <div class="col-sm-4 col-md-4">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="temp_time">測量時間</label> 
                    <div class="col-sm-4 col-md-4">
            ...
            <form class="form-horizontal" action="/GoFightWin/BasicData/add_pressure_action" method="post">
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="systolic">血壓</label>  
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="heartbeat">心跳</label>
                    <div class="col-sm-2 col-md-1">
                        <input id="heartbeat" name="heartbeat" type="text" placeholder="" class="form-control input-md">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="pressure_date">測量日期</label>  
                    <div class="col-sm-4 col-md-4">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="pressure_time">測量時間</label>  
                    <div class="col-sm-4 col-md-4">
            ...
            <form class="form-horizontal" action="/GoFightWin/BasicData/add_defecation_action" method="post">
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="defecation_date">排便</label>  
                    <div class="col-sm-4 col-md-4">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-1 control-label" for="defecation_time"></label>  
                    <div class="col-sm-4 col-md-4">
